...
/****** Object: SqlProcedure [dbo].[sp_Dl_ReturnAllOrderDetails] Script Date: 22/04/2020 22:11:07 ******/
SET ANSI_NULLS ON
GO
...
dlo.DlOrderQuantity as DlOrderCurrentQuantity, DlOrderDate as DlOrderDate, cast(DlOrderStatusStatus as varchar(50)) as DlOrderStatusStatus,
